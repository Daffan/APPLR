...
def path_to_world(w):
    if w in Benchmarking_train:
        return '/jackal_ws/src/jackal_helper/worlds/Benchmarking/train/world_%d.world' %(w)
    elif w in Benchmarking_test:
        return '/jackal_ws/src/jackal_helper/worlds/Benchmarking/test/world_%d.world' %(w)
    else:
